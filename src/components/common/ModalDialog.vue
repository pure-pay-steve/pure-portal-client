...
<template>
    ...
    <div id="authentication-modal" aria-hidden="true" ref="modal"
        class="flex overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center bg-slate-300/50">
