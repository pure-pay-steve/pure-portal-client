...
<template>
  <Disclosure as="nav"
    class="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% shadow rounded"
    v-slot="{ open }">
    <div class="mx-auto px-2 sm:px-4 lg:pl-2 lg:pr-8">
          ...
          <div class="flex flex-shrink-0 items-center">
            <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg">
              <linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style="stop-color:rgb(32,196,0);stop-opacity:1" />
                <stop offset="100%" style="stop-color:rgb(0,255,0);stop-opacity:1" />
              </linearGradient>
              <rect x="0" y="0" width="14" height="14" rx="3" ry="3" fill="url(#grad)" />
              <rect x="15" y="0" width="14" height="14" rx="3" ry="3" fill="url(#grad)" />
              <rect x="0" y="15" width="14" height="14" rx="3" ry="3" fill="url(#grad)" />
              <rect x="15" y="15" width="14" height="14" rx="3" ry="3" fill="url(#grad)" />
              <text x="4" y="25" font-family="var(--ag-font-family)" font-bold font-size="10" fill="white">P</text>
            </svg><span class="pl-2 text-xl font-bold">Pure Payroll</span>
          </div>
